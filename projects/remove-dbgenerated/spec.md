...
- ADR 184 — its PSL half is replaced by ADR 253: a codec descriptor names the literal types it is compatible with, and gains no methods (D9, D10). DDL methods remain future work.
