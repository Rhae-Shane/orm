...
export type FieldOutputTypes = {
  readonly public: {
    readonly Stamp: {
      ...
      readonly updatedAtTz: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Stamp: {
      ...
      readonly updatedAtTz: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
  };
};
          ...
          readonly Stamp: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly updatedAtTz: { readonly column: 'updatedAtTz' };
              };
            };
          };
        };
